...
const createProductValidation = Joi.object({
    ...
    subCategoryName: Joi.string().required().trim(),
    smallCategoryNames: Joi.string().required().trim(),
...
const updateProductValidation = Joi.object({
    ...
    kidsSize: Joi.string().optional().default('none'),
    ...
    subCategoryName: Joi.string().optional().trim(),
    smallCategoryNames: Joi.string().optional().trim(),
